...
<!-- RESULTS:START -->
_Results are generated by running the pipeline; see [Usage](#usage). Run
`python scripts/report.py` to regenerate `outputs/resume_metrics.md` from measured runs._
<!-- RESULTS:END -->
